...
subprocess.call("find . -mindepth 2 -maxdepth 2 -name '*.pep'  | xargs -I % cat % >> combined.pep", shell=True) #To omit B. luti seqs
...
#4a. Identify list of shared sequences
#wd: /home/ijmiller/AMPHORA2/MIX-51/GCA_000156495.1_ASM15649v1_genomic perl ../Scripts/MarkerScanner.pl -DNA \-Bacteria /home/ijmiller/MIX-51/reference_fasta_files/GCA_000156495.1_ASM15649v1_genomic.fna(Do the same in /home/ijmiller/AMPHORA2/MIX-51//GCA_000012825.1_ASM1282v1_genomic2.
#Combine protein marker sequences with cat
#wd: /home/ijmiller/AMPHORA2/MIX-51/combined
#cat ../GCA_000156495.1_ASM15649v1_genomic/*pep \../GCA_000012825.1_ASM1282v1_genomic/*pep>combined.pep3.
#Reformat combined protein sequence file with another run of AMPHORA’s
#perl ../../Scripts/MarkerScanner.pl -Bacteria combined.pepThis effectivelly separates out all of the markers into individual multifasta .pep files that appear consistent informat with media/box1/AMPHORA_example/AMPHORA/cobmined/*.pep1
...
#Blautia luti is missing: rpsJ,rplT,tsf,rpmA,rplF,rplM
#Could omit this one...
