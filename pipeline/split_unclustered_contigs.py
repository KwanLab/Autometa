...
parser = argparse.ArgumentParser(
    description="Split list of unclustered contigs\
...
parser.add_argument(
    "-b",
    "--block_size",
    help="Number of contigs to place in \
    each split list file.",
    default=100,
)
parser.add_argument(
    "-u",
...
unclustered_contig_table = contig_table.loc[
    contig_table[cluster_column_name] == unclustered_name
]
